...
import type { IAuthorResponse, IAuthorsResponse } from "@src/interfaces/response.interface";
...
export declare class AuthorSerivce {
    #private;
    constructor(authorRepository: AuthorRepository, articleRepository: ArticleRepository, seriesRepository: SeriesRepository, authorArticleRepository: ArticleAuthorRelationshipRepository, chapterRepository: ChapterRepository);
