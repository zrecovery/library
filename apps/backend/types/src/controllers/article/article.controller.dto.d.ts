...
export declare const ArticleEditRequestDto: import("@sinclair/typebox").TObject<{
    ...
    book: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString>;
...
export declare const ArticleDetailSchema: import("@sinclair/typebox").TObject<{
    ...
    authors: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TArray<import("@sinclair/typebox").TObject<{
        id: import("@sinclair/typebox").TNumber;
        name: import("@sinclair/typebox").TString;
    }>>>;
    series: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TObject<{
        id: import("@sinclair/typebox").TNumber;
        title: import("@sinclair/typebox").TString;
    }>>;
