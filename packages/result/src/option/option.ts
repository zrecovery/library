 ...
 */
type NonUndefined = NonNullable<unknown> | null | undefined; // eslint-disable-line @typescript-eslint/ban-types
...
export interface Option<T extends NonUndefined> {
   ...
   * ```
   */
  match<U extends NonUndefined | undefined>(fn: Match<T, U>): U;
 ...
 * ```
 */
export const None: NoneOption<NonUndefined> = new NoneImpl(); // eslint-disable-line
