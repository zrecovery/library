...
import { type Id, IdSchema } from "@library/domain";
import {
  NotFoundStoreError,
  UnknownStoreError,
} from "@library/domain/interfaces/store.error";
import { AuthorSchema } from "@library/domain/types/author";
import { ChapterSchema } from "@library/domain/types/chapter";
import type { Database } from "./db";
import * as schema from "../../../shared/store/schema";
import type { AuthorDetail } from "../../../domain/src/modules/articles/domain";
