...
import type { ArticleRepository, Query } from "@/core/article/repository/ArticleRepository";
import { type PrismaClient } from "@prisma/client";
export class ArticlePrismaRepository implements ArticleRepository {
    #client: PrismaClient; constructor(client: PrismaClient) {
        this.#client = client;
    }
    ...
    public getArticlesByAuthorId = async (id: number, limit: number, offset = 0): Promise<Article[]> => {
    ...
    public getArticles = async (limit: number, offset = 0): Promise<Article[]> => {
    ...
    public searchArticles = async (query: Query, limit: number, offset = 0): Promise<Article[]> => {
