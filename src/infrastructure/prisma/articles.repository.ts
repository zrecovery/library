    ...
    public searchArticles = async (
        ...
        switch (mode) {
            case Mode.keywordAndLove:
                count = await this.#client.$queryRaw`SELECT COUNT(*) FROM (SELECT "public"."articles"."id" FROM "public"."articles" WHERE body %% ${keyword}  WHERE love = ${love} )AS "sub"`;
                break;

            case Mode.keyword:
                count = await this.#client.$queryRaw`SELECT COUNT(*) FROM (SELECT "public"."articles"."id" FROM "public"."articles" WHERE body %% ${keyword}  ) AS "sub"`;
                break;

            case Mode.love:
                count = await this.#client.$queryRaw`SELECT COUNT(*) FROM (SELECT "public"."articles"."id" FROM "public"."articles" WHERE love %% ${love}  ) AS "sub"`;
                break;
            case Mode.no:
                count = await this.#client.$queryRaw`SELECT COUNT(*) FROM (SELECT "public"."articles"."id" FROM "public"."articles") AS "sub"`;
                break;
