...
export class ArticleAuthorRelationshipMockRepository implements ArticleAuthorRelationshipRepository {
    ...
    list(query?: Query | undefined): Promise<PaginatedResponse<Required<ArticleAuthorRelationship>[]>> {
        throw new Error("Method not implemented.");
    }
}